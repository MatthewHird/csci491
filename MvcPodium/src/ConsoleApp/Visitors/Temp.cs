...
{
    class TempServiceInterfaceVisitor //: CSharpParserBaseVisitor<object>
    {
        ...
        //public TempServiceInterfaceVisitor(BufferedTokenStream tokenStream)
        //{
        ...
        //    var directives = context.using_directives().using_directive();

        //    foreach (var directive in directives)
        //    {
        //        int a = directive.Start.StartIndex;
        //        int b = directive.Stop.StopIndex;
